	...
	return (
		<div className='text-white'>
			<div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
				<p className='text-[#009dfa] font-bold p-2'>
				...
				<div className='flex justify-center items-center md:text-5xl sm:text-4xl text-xl font-bold'>
					...
					<Typed
						className='md:pl-4 pl-2 text-gray-500'
				...
				<button className='bg-[#009dfa] w-[200px] rounded-full font-medium my-6 mx-auto py-3 text-black'>
					Get Started
				</button>
			</div>
		</div>
